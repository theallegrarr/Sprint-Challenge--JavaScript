...
*/
class dinosaurs {
  constructor(name_, diet_, weight_, length_, period_){
    this.name = name_;
    this.diet = diet_;
    this.weight = weight_;
    this.length = length_;
...
let tyrannosaurus = new dinosaurs('tyrannosaurus','carnivorous','7000kg','12m','Late Cretaceous');

// stegosaurus, herbivorous, 2000kg, 9m, Late Jurassic
let stegosaurus = new dinosaurs('stegosaurus','herbivorous','2000kg','9m','Late Jurassic');

// velociraptor, carnivorous, 15kg, 1.8m, Late Cretaceous
let velociraptor = new dinosaurs('velociraptor','carnivorous','15kg','1.8m','Late Cretaceous');
...
const uni = graduates.filter(str => str.university.indexOf("Uni") > 0 || str.university.indexOf("uni") > 0);
console.log(uni);
...
*/
const animalNames = [];
zooAnimals.forEach(animal => animalNames.push({animal_name: animal.animal_name, scientific_name: animal.scientific_name}));
